...
async function createAccount(username, password, key) {
	...
	let query = {
		query: `mutation createUser($username: String!, $password: String!, $key: String!, $passraw: String!) {
			createUser(username: $username, password: $password, key: $key, passraw:$passraw)
		}`,
		variables: {
			username: username,
...
async function getVersion() {
	...
	return request("POST", urlAPI.replace("graphql", "version"), body, null);
}
